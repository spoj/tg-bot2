...
DATA_DIR/chats/<numeric-chat-id>/
  workspace/                         # persistent writable worker bind
    ...
    .tg-bot/events.jsonl # full chat interaction log (host-written, append-only)
