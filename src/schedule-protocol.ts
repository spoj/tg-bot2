...
/**
 * Renders the SCHEDULES protocol section of the SYSTEM_PROMPT: the shape of
 * /workspace/.tg-bot/schedules.json as validated by the scheduler, derived
 * from {@link ScheduleRecord}.
 */
export function renderSchedulesPrompt(): string {
  return `Schedules are stored in /workspace/.tg-bot/schedules.json. Its root object is
